...
public class ActitimeAssignment1 extends SeleniumUtility{
	String AppUrl;
	String UserName;
	String Password;
	...
	public void actitimeLogin() {
		...
		if (getCurrentTitleOfApplication("actiTIME - Enter Time-Track").equals("actiTIME - Enter Time-Track")) {
			ExcelUtility.updateExcelContent(".\\src\\test\\resources\\testData\\AppTest.xlsx", "Sheet2", 3, 5,
					"Passed");
			ExcelUtility.updateExcelContent(".\\src\\test\\resources\\testData\\AppTest.xlsx", "Sheet2", 3, 4,
