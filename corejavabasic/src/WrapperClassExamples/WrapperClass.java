...
public class WrapperClass {
	...
	public static void main(String[] args) {
		...
		//convering integer to int
		Integer a1 = new Integer(25);
		int il = a1.intValue();//converting Integer to int explicitly 
		System.out.println("a1: "+a1+"\nil: "+il);
		
		System.out.println("a1==il: "+(a1==il));
		System.out.println("a1.equals(il): "+a1.equals(il));
